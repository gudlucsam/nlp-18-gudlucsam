...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="Does a Sentiment analysis for reviews using both a Logistic Regression model and a Multinomial Naive Bayes distribution model.")
    ...
    parser.add_argument("test-file", help="accepts the text file to peform sentiment analysis on.")
    ...
    if test_file:
        ...
        if classifier_type == "nb":
            if version == "n":
                ...
                print("invalid version was specified.")

        # logistic regression
        if classifier_type == "lr":
            if version == "n":
                nlrPredict(test_file)
            elif version == "u":
                ulrPredict(test_file)
            else:
                print("invalid version was specified.")

        # error if classifier specified is not available
        if classifier_type != "nb" and classifier_type != "lr":
            print("invalid classifier type was specified.")

    else:
        print("invalid test file to perform sentiment analysis.")
